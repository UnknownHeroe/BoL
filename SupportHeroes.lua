...
function HTTF_Viktor:Update()
  ...
  ToUpdate.CallbackUpdate = function(NewVersion, OldVersion) print("<font color=\"#FF3300\"><b>[Support Heroes] </b></font> <font color=\"#FFFFFF\">Updated to "..ServerVersion..". </b></font>") end
  ToUpdate.CallbackNoUpdate = function(OldVersion) print("<font color=\"#FF3300\"><b>[Support Heroes] </b></font> <font color=\"#FFFFFF\">No Updates Found!</b></font>") end
  ToUpdate.CallbackNewVersion = function(NewVersion) print("<font color=\"#FF3300\"><b>[Support Heroes] </b></font> <font color=\"#FFFFFF\">New Version found ("..ServerVersion.."). Please wait until its downloaded!</b></font>") end
